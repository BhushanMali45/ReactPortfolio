...
.
        ...
        <div className="a-pr">
<b>          I have got  1st price Web Design in Milestone 2k22.
</b>          <p>I have worked on Frontend technologies (HTML, CSS, BootStraps, Javascript,React Js) and Backend technologies(Node js ,Mongodb And Mysql ) for almost a year and had done several projects.
...
Aspiring for a challenging career in Software Development as to use my learned skills and experience </p>
          ...
          <div className="resume">
            <a href="https://drive.google.com/file/d/14AycoucccWSOTdUb5qfxoa0RX2MNqkII/view?usp=drivesdk " className="btn" download> Download Resume </a>
          </div>
        </div>
      </div>
